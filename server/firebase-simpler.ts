...
// Initialize Firebase Admin with minimal credentials
if (!admin.apps.length) {
  try {
    // Initialize with just project ID - credential will be inferred when possible
    admin.initializeApp({
...
// Storage implementation using Firebase Admin directly
